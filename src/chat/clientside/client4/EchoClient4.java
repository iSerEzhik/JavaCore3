package chat.clientside.client4;
...
public class EchoClient4 extends JFrame {
    ...
    public void prepareGUI() {
        ...
        chatArea.setBackground(new Color(190, 171, 212));
    ...
    private class Logs{
        private final File myLog = new File("src//chat.clientside//client4//logs.txt");
