package chat.clientside.client5;
...
public class EchoClient5 extends JFrame {
    ...
    public void prepareGUI() {
        ...
        chatArea.setBackground(new Color(255, 218, 226));
    ...
    private class Logs{
        private final File myLog = new File("src//chat.clientside//client5//logs.txt");
